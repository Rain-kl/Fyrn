...
package net.arctel.oms.scheduled;

import static net.arctel.oms.common.constants.RedisPrefixConstant.THREAD_POOL_METRICS;
...
//    @Scheduled(fixedDelay = 1000)
    ...
    public ThreadPoolMetricsDTO getCurrentMetrics() {
        ThreadPoolExecutor executor = taskExecutor.getThreadPoolExecutor();
        return ThreadPoolMetricsDTO.collectMetrics(executor);
    }

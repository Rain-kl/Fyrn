  ...
  <div class="flex flex-col space-y-4">
    ...
    >
      <div class="grid w-full gap-2 md:grid-cols-4">
        ...
        <NInput v-model="filters.novelTitle" placeholder="小说名称" />

        <NInput v-model="filters.novelAuthor" placeholder="小说作者" />
    ...
    <div class="flex flex-wrap items-center gap-4 px-1">
      ...
      <NCheckbox
        v-for="tableColumn in table
          ?.getAllLeafColumns()
          .filter(
            (c) => typeof c.columnDef.header === 'string' && c.id !== 'actions'
          )"
        :key="tableColumn.id"
